...
if(1){
	if( is_uploaded_file($file['tmp_name']) ){
		$encdata = EncryptFile::encryptDataUser( file_get_contents($file['tmp_name']) );
...
if(1){
		$refData = EncryptFile::decryptDataUser( file_get_contents($filename) );
...
if(1){
		...
		$this->encryptedMethod = $fileInfo->encryptedMethod ? : false;
...
<dl>
 ...
 <dd>Encrypted:{$this->encryptedMethod}</dd>
...
EOD;
	...
	function encrypt()
	{
		if( EncryptFile::encryptConvertFileUser($this->filename) ){
